...
<h1>
    URL::   {{url('/').'/api/replyOnComment'}}

</h1>
<form method="POST" enctype="multipart/form-data" action="{{url('/api/replyOnComment')}}" >
    ...
    <br/> <br/>
    Reply (reply) ::  *
    <textarea rows="4" cols="50" name="reply" placeholder="Reply here ">
