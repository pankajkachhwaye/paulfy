...
<form method="POST" enctype="multipart/form-data" action="{{url('/api/register')}}" >



    User Name(user_name) ::*<input type="text"  name="user_name" >
    <br />
    <br />
    Emai(email) ::*<input type="email" name="email" >
    <br />
    <br />
